...
const __iconData = {
  ...
  node: [
    ...
    ["path", { d: "m9 21 2-14", key: "1em7wr" }]
  ]
};
__iconData.node;
const CreditCardReader = createLucideIcon(__iconData);

export { __iconData, CreditCardReader as default };
//# sourceMappingURL=credit-card-reader.mjs.map
