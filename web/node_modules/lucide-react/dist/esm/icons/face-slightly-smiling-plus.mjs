...
__iconData.node;
const FaceSlightlySmilingPlus = createLucideIcon(__iconData);

export { __iconData, FaceSlightlySmilingPlus as default };
//# sourceMappingURL=face-slightly-smiling-plus.mjs.map
